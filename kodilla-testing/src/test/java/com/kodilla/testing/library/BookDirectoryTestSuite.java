...
class BookDirectoryTestSuite {
    ...
    public void testListBooksInHandsOfZero(){
        ...
        LibraryUser libraryUser = new LibraryUser("John", "Smith","0027873245");
    ...
    public void testListBooksInHandsOfOne(){
        ...
        LibraryUser libraryUser = new LibraryUser("John", "Smith","027873245");
        List<Book> resultBooksInHandsOfOne = new ArrayList<>();
        resultBooksInHandsOfOne.add(new Book("Book Title", "Author Name", 1883));
